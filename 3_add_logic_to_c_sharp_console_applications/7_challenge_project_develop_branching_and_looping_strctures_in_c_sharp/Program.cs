...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                animalID = ourAnimals[i, 0].Substring(ourAnimals[i, 0].IndexOf(':') + 1).Trim();
                if (animalID == "")
                    continue;
                ...
                if (ourAnimals[i, 4].Substring(ourAnimals[i, 4].IndexOf(':') + 1).Trim().Length == 0)
                {
                    do
                    {
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                ...
                if (ourAnimals[i, 3].Substring(ourAnimals[i, 3].IndexOf(':') + 1).Trim().Length == 0)
                {
                    do
                    {
                ...
                if (ourAnimals[i, 5].Substring(ourAnimals[i, 5].IndexOf(':') + 1).Trim().Length == 0)
                {
                    do
                    {
