...
string[] petAttributes = {"Id", "Species", "Age", "Nickname", "Physical Description", "Personality"};
...
do {
    ...
    menuSelection = (string)readResult;
    ...
    switch(menuSelection)
    {
        case "1":
            ...
            {
                if (ourAnimals[j, 0] == null)
                    break;

                for(i = 0; i < petAttributes.Length; i++)
                {
                    Console.WriteLine($"{petAttributes[i]}: {ourAnimals[j, i]}");
                }
